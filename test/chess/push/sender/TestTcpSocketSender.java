...
public final class TestTcpSocketSender {
            ...
            bootstrap.group(group)
                     ...
                     .handler(new ChannelInitializer<SocketChannel>() {
                         ...
                         protected void initChannel(SocketChannel ch) throws Exception {
                             ...
                             pipeline.addLast(new TestTcpSocketSenderHandler());
                         }
                     });
            ...
            future.addListener(new ChannelFutureListener() {
                ...
                public void operationComplete(ChannelFuture future) throws Exception {
                    for (int cnt = 1; cnt <= testCount; cnt++) {
                        PushMessage message = new PushMessage(testServiceId, testGroupId, testClientId, "TcpSocket test message [" + cnt + "]");
...
class TestTcpSocketSenderHandler extends SimpleChannelInboundHandler<PushMessage> {

    private static final Logger LOG = LoggerFactory.getLogger(TestTcpSocketSenderHandler.class);
